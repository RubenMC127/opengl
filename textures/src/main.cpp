...
unsigned int createProgram() {
    ...
    const char* fragmentShaderSource = "#version 450 core\n"
        ...
        "void main()\n"
        "{\n"
        "   fragColor = vec4(fColor, 1.0) * texture(basicTexture, fTexCoords);\n"
        "}\0";
...
int main(void)
{
    ...
    // Defining Color Attribute at index 1 of attrib
    ...
    glVertexArrayAttribFormat(VAO, 2, 2, GL_FLOAT, GL_FALSE, 6*sizeof(float)); // 3 last floats of the vertex
